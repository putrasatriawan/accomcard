...
class Talent_pg extends CI_Controller
{
    ...
    public function talent_pg_show($id_kategori_pg)
    {

        $kategori_pg = $this->m_barang->kategori_pg($id_kategori_pg);
        $data = array(
            'title' => 'Kategori Talent PhotoGrapher',
            'barang' => $this->m_barang->get_all_data_pg($id_kategori_pg),
            'isi' => 'v_edit_talent',
        );
        $this->load->view('layout/v_wrapper_backend', $data, FALSE);
    }

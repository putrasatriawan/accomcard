        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <img src="<?= base_url('assets/img/galerikecil.png') ?>" id="gambar_load" width="200px" alt="">
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <?php foreach ($gambar as $key => $value) { ?>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <img src="<?= base_url('assets/gambarbarang/' . $value->gambar) ?>" id="gambar_load" width="250px" height="200px" alt="">
                        </div>
                        <p>Ket : <?= $value->ket ?> </p>
                        <button data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>" class="btn btn-primary btn-xs btn-block "><i class="fa fa-trash"> </i>Delete</button>
                    </div>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <h5>Apakah anda ingin menghapus gambar ini?</h5>

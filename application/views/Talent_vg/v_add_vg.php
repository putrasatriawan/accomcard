<div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Form Tambah Talent VG</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            echo form_open_multipart('talent_vg/add')  ?>

            <div class="form-group">
                <label>Nama Talent</label>
                <input name="nama_barang" type="text" class="form-control" placeholder="Nama Talent" value="<?= set_value('nama_barang') ?>">
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Harga / Rate</label>
                        <input name="harga" type="text" class="form-control" placeholder="Harga Talent" value="<?= set_value('harga') ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
